...
def fetch_poster(movie_id):
    url = f"https://api.themoviedb.org/3/movie/{movie_id}?api_key=07f211e99d167974df097a5666350356&language=en-US"
...
with gzip.open(os.path.join(BASE_DIR, "similarity.gz"), "rb") as file:
